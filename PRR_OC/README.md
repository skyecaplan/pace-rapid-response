...
# Bloom_Detection
Subdirectory within PRR_OC repository containting the files for the construction of the automatic potential [Bloom Detection Dashboard]
(https://oceancolor.gsfc.nasa.gov/fileshare/graham_trolley/chla_anomaly_rapid_response/) The most important files for end-users within the subdirectory are listed below.
